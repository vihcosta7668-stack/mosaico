...
try {
  // conteúdo das situações: fonte única, viaja com o app, sem rede
  const conteudo = await import("../conteudo/situacoes.js");
  ...
  pronto({ configurado, conteudo, store, auth, sync, prog });
} catch (e) {
